...
function render(variables = {}) {
  ...
  if (variables.name == null) name = "Nombre";

  let lastName = variables.lastName;
  if (variables.lastName == null) lastName = "Apellido";

  let role = variables.role;
  if (variables.role == null) role = "Profession";

  let city = variables.city;
  if (variables.city == null) city = "Pais";

  let country = variables.country;
  if (variables.country == null) country = "Ciudad";
  ...
  } else if (variables.socialMediaPosition == "Left") {
